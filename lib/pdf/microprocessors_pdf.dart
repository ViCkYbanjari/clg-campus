...
class Microprocessors extends StatefulWidget {
  const Microprocessors({super.key});

  @override
  State<Microprocessors> createState() => _MicroprocessorsState();
}

class _MicroprocessorsState extends State<Microprocessors> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: backgroundcolor,
        title: Text("Microprocessors & Interfaces",
          style: TextStyle(
