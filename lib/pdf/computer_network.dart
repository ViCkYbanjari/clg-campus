...
class ComputerNetwork extends StatefulWidget {
  const ComputerNetwork({super.key});

  @override
  State<ComputerNetwork> createState() => _ComputerNetworkState();
}

class _ComputerNetworkState extends State<ComputerNetwork> {
  ...
  void initState() {
    ...
    pdfControllerPinch = PdfControllerPinch(document: PdfDocument.openAsset(
        'assets/pdf/computer_network.pdf'
    )
    );
  }
  @override
